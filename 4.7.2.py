# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 15:23:29 2016
@author: Wang
"""
...
scatter(0,0,s=1,color='black')
title('beta=2',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
